...
export default {
  ...
  methods: {
    drawStyleFactorExposureRadar () {
      let ctx = document.getElementById('schoolRadar').getContext('2d')
      console.log(66666, this.indic)
      console.log(7777, this.data1)
        ...
        data: {
          ...
          datasets: [
            ...
            },
            {
              label: '合格达成度',
              fillColor: 'rgba()',
              strokeColor: 'rgba(255,220,220,0.2)',
        ...
        options: {
          ...
          scale: {
            ...
            ticks: {
              ...
              // maxTicksLimit: 100,
              suggestedMin: 0,
              suggestedMax: this.indic[0].max,
              stepSize: this.indic[0].max / 10,
              display: false,
              fontColor: '#DC143C',
